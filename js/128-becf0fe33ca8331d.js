...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
   [128], {
      94016: function (r, n, t) {
         ...
         function d() {
            var r = (0, s.Z)(["\n  transform: translateY(-40%);\n\n  html.enhanced & {\n    transform: none;\n    transition: ", " cubic-bezier(0.3, 1.17, 0.55, 0.99);\n    transition-property: transform, background;\n    filter: drop-shadow(0px 8px 10px rgba(0, 0, 0, 0.35));\n    will-change: var(--will-change, transform, background, filter);\n  }\n\n  html.enhanced .visible & {\n    transform: translateY(-40%);\n  }\n\n  @media (max-width: 768px) {\n    font-size: 48px;\n  }\n"]);
            return d = function () {
               return r
            }, r
         }
         ...
         function Z() {
            var r = (0, s.Z)(["\n  isolation: isolate;\n  position: relative;\n  overflow: hidden;\n  padding: 56px;\n  display: flex;\n  flex-direction: column;\n  justify-content: ", ";\n  flex: 1;\n\n  --radius: 48px;\n  border-radius: var(--radius);\n  ", "\n  perspective: 20000px;\n  aspect-ratio: 1.1 / 1;\n  background: radial-gradient(ellipse at center, rgba(var(--rgb), 0.15), var(--transparent));\n\n  & img {\n    position: absolute;\n    top: 0;\n    user-select: none;\n    pointer-events: none;\n    border-radius: 12px;\n  }\n\n  & ", " {\n    max-width: 310px;\n  }\n\n  @media (max-width: 768px) {\n    padding: 24px 32px;\n    width: 100%;\n    --radius: 24px;\n    background: radial-gradient(ellipse at 50% 80%, rgba(var(--rgb), 0.15), var(--transparent));\n  }\n"]);
            return Z = function () {
               return r
            }, r
         }
         ...
         function N() {
            var r = (0, s.Z)(["\n  position: relative;\n  overflow-x: hidden;\n  padding-top: 420px;\n  margin-top: -164px;\n  contain: content;\n\n  --will-change: none;\n\n  /* Apply will-change hints when this section is close to being visible */\n  .enabled & {\n    --will-change: initial;\n  }\n\n  --rgb: ", ';\n\n  &::after {\n    content: "";\n    position: absolute;\n    pointer-events: none;\n    user-select: none;\n    inset: 0;\n    opacity: 0.8;\n    background: radial-gradient(ellipse 100% 40% at 50% 60%, rgba(var(--rgb), 0.1), var(--transparent));\n  }\n\n  html.enhanced &::after {\n    opacity: 0;\n    transition: opacity ', ";\n    will-change: var(--will-change, opacity);\n  }\n\n  html.enhanced &.visible::after {\n    opacity: 0.8;\n  }\n\n  @media (max-width: 768px) {\n    padding-top: 256px;\n    margin-top: -128px;\n  }\n"]);
            return N = function () {
               return r
            }, r
         }
         ...
         function A() {
            var r = (0, s.Z)(['\n  margin-top: -128px;\n  margin-bottom: -128px;\n  padding-top: 128px;\n  padding-bottom: 128px;\n\n  position: relative;\n\n  &::after {\n    content: "";\n    position: absolute;\n    pointer-events: none;\n    user-select: none;\n    inset: 0;\n    opacity: 0;\n    background: radial-gradient(ellipse 50% 50% at center, rgba(var(--rgb), 0.1), var(--transparent));\n    transition: opacity ', ";\n    will-change: var(--will-change, opacity);\n  }\n\n  .visible &::after {\n    opacity: 0.8;\n  }\n\n  & + ", " {\n    position: relative;\n  }\n"]);
            return A = function () {
               return r
            }, r
         }
         ...
         var F = "960ms",
            G = (0, f.ZP)(m.x).attrs((function (r) {
               return {
                  fontSize: 80,
                  lineHeight: .9,
                  letterSpacing: "-0.01em",
                  fontWeight: 450,
                  margin: null !== (c = r.margin) && void 0 !== c ? c : 0
               }
            })).withConfig({
               componentId: "sc-fb2ff78c-0"
            })(d(), F),
            J = (0, f.ZP)(m.x).attrs((function (r) {
               return {
                  fontSize: 32,
                  lineHeight: 1.2,
                  fontWeight: 450,
                  margin: null !== (o = r.margin) && void 0 !== o ? o : 0
               }
            })).withConfig({
               componentId: "sc-fb2ff78c-1"
            })(g()),
            K = (0, f.ZP)(m.x).attrs((function (r) {
               return {
                  fontSize: 24,
                  lineHeight: 1.3,
                  letterSpacing: "-0.01em",
                  fontWeight: 450,
                  margin: null !== (e = r.margin) && void 0 !== e ? e : 0
               }
            })).withConfig({
               componentId: "sc-fb2ff78c-2"
            })(j()),
            M = (0, f.ZP)(m.x).attrs((function (r) {
               return {
                  fontSize: 16,
                  lineHeight: 1.5,
                  fontWeight: 450,
                  margin: null !== (a = r.margin) && void 0 !== a ? a : 0
               }
            })).withConfig({
               componentId: "sc-fb2ff78c-3"
            })(h()),
            R = (0, f.ZP)(m.x).attrs((function (r) {
               return {
                  fontSize: 22,
                  lineHeight: 1.3,
                  fontWeight: 400,
                  margin: null !== (i = r.margin) && void 0 !== i ? i : 0
               }
            })).withConfig({
               componentId: "sc-fb2ff78c-4"
            })(b()),
            V = f.ZP.div.attrs({
               ariaHidden: !0
            }).withConfig({
               componentId: "sc-fb2ff78c-5"
            })(v()),
            D = (0, f.ZP)(V).withConfig({
               componentId: "sc-fb2ff78c-6"
            })(w()),
            L = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-7"
            })(Z(), (function (r) {
               return r.$reverse ? "flex-end" : "flex-start"
            }), (0, l.AN)(1, "linear-gradient(to bottom, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))"), M),
            O = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-8"
            })(k()),
            Q = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-9"
            })(C()),
            T = f.ZP.div.attrs({
               ariaHidden: !0
            }).withConfig({
               componentId: "sc-fb2ff78c-10"
            })(I(), (function (r) {
               return r.$color || "#b254eb"
            }), (function (r) {
               return r.theme.color.pageBg
            }), (function (r) {
               return x.N.cssWithAlpha(r.$color, .4)
            })),
            q = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-11"
            })(P()),
            X = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-12"
            })(z(), (0, l.AN)(1, "linear-gradient(to bottom, rgba(255, 255, 255, 0.3), rgba(255, 255, 255, 0) 120%)")),
            rr = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-13"
            })(S()),
            nr = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-14"
            })(H(), (function (r) {
               return r.theme.color.pageBg
            }), F),
            tr = f.ZP.section.withConfig({
               componentId: "sc-fb2ff78c-15"
            })(N(), (function (r) {
               return r.$rgb
            }), F),
            cr = (0, f.ZP)(p.b).withConfig({
               componentId: "sc-fb2ff78c-16"
            })(A(), F, y.r),
            or = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-17"
            })(W()),
            er = (0, f.ZP)(p.b).withConfig({
               componentId: "sc-fb2ff78c-18"
            })($()),
            ar = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-19"
            })(_(), (0, l.AN)(1, "linear-gradient(to bottom, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.07))")),
            ir = (0, f.ZP)(m.x).attrs({
               fontSize: 26,
               fontWeight: 450,
               lineHeight: 1.2,
            ...
            sr = (0, f.ZP)(m.x).attrs({
               ...
               componentId: "sc-fb2ff78c-21"
            })(Y()),
            fr = f.ZP.div.withConfig({
               componentId: "sc-fb2ff78c-22"
            })(U()),
            xr = (0, f.ZP)(u.Z).attrs({
               kind: "fading"
            }).withConfig({
               componentId: "sc-fb2ff78c-23"
            })(E())
      },
      26793: function (r, n, t) {
         t.d(n, {
            O: function () {
               return a
            }
         ...
         function e() {
            var r = (0, c.Z)(["\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  mask-image: radial-gradient(circle at bottom center, black, transparent);\n"]);
            return e = function () {
               return r
            }, r
         }
         ...
         t(70079);
         var i = t(68438).ZP.svg.withConfig({
            componentId: "sc-bf8b3d70-0"
         })(e())
      },
      40223: function (r, n, t) {
         t.d(n, {
            M: function () {
               return s
            },
         ...
         function e() {
            var r = (0, c.Z)(["\n  --gap: 24px;\n\n  padding-left: var(--page-padding-left);\n  padding-right: var(--page-padding-right);\n  max-width: var(--page-max-width);\n  width: 100%;\n  margin: 0 auto;\n\n  display: grid;\n  --row: minmax(0, 1fr);\n  grid-template-columns:\n    [page-start] var(--row) [prose-start] var(--row) var(--row) var(--row) var(--row) [prose-end] var(--row)\n    [page-end];\n  grid-gap: var(--gap);\n\n  @media (max-width: 768px) {\n    --gap: 16px;\n    grid-template-columns: [page-start prose-start] var(--row) var(--row) var(--row) var(--row) [page-end prose-end];\n  }\n"]);
            return e = function () {
               return r
            }, r
         }
         ...
         var i = o.ZP.div.withConfig({
               componentId: "sc-31372167-0"
            })(e()),
            s = o.ZP.div.attrs({
               className: "prose"
            }).withConfig({
               componentId: "sc-31372167-1"
            })(a())
      }
   }
]);