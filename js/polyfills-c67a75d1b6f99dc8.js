! function () {
    ...
    var Mo = Br("Set", (function (t) {
       ...
       Co = function (t, e) {
          ...
          if (null === n) return r;
          var o, i, a = Co(n, e);
          return a.length ? r.length ? (o = new Mo(r.concat(a)), Nr(o, (i = []).push, i), i) : a : r
       };
    Lt({
       target: "Reflect",
       stat: !0
    ...
    var Zo = o((function () {
       ...
       li = ei.UNSUPPORTED_Y;
    if (i && Tt("RegExp", !fi || li || o((function () {
          return ci[ii] = !1, ai(si) != si || ai(ci) == ci || "/a/i" != ai(si, "i")
       })))) {
       for (var hi = function (t, e) {
             var r, n = this instanceof hi,
                o = Yo(t),
                i = void 0 === e;
             if (!n && o && t.constructor === hi && i) return t;
             fi ? o && !i && (t = t.source) : t instanceof hi && (i && (e = Jo.call(t)), t = t.source), li && (r = !!e && e.indexOf("y") > -1) && (e = e.replace(/y/g, ""));
    ...
    (o((function () {
       ...
       var t = j(this),
          e = String(t.source),
          r = t.flags;
       return "/" + e + "/" + String(void 0 === r && t instanceof RegExp && !("flags" in yi) ? Jo.call(t) : r)
    }), {
       unsafe: !0
    });
    ...
    Lt({
       ...
       exec: Oi
    }), i && ("g" != /./g.flags || ei.UNSUPPORTED_Y) && I.f(RegExp.prototype, "flags", {
       configurable: !0,
       get: Jo
    });
    var Ri = et.get,
       ji = RegExp.prototype;
    i && ei.UNSUPPORTED_Y && (0, I.f)(RegExp.prototype, "sticky", {
       configurable: !0,
       get: function () {
          if (this !== ji) {
    ...
    var Pi, Ii, Ti = (Pi = !1, (Ii = /[ac]/).exec = function () {
       ...
       Fi = function (t, e, r, n) {
          var i = qt(t),
             ...
             u = a && !o((function () {
                var e = !1,
                   r = /a/;
                return "split" === t && ((r = {}).constructor = {}, r.constructor[Li] = function () {
                   return r
                }, r.flags = "", r[i] = /./ [i]), r.exec = function () {
                   return e = !0, null
                }, r[i](""), !e
             }));
          if (!a || !u || "replace" === t && (!Ui || !Mi || Ni) || "split" === t && !Ci) {
             var s = /./ [i],
    ...
    Fi("replace", 2, (function (t, e, r, n) {
       ...
       function u(t, r, n, o, i, a) {
          var u = n + t.length,
             s = o.length,
             c = $i;
          return void 0 !== i && (i = Ut(i), c = Gi), e.call(a, c, (function (e, a) {
             var c;
             switch (a.charAt(0)) {
                case "$":
                   return "$";
    ...
    var pa = wt.f,
       da = {}.toString,
       va = "object" == typeof window && window && Object.getOwnPropertyNames ? Object.getOwnPropertyNames(window) : [],
       ga = {
          f: function (t) {
       ...
       Wa = function (t, e, r) {
          t === Ra && Wa(Ma, e, r), j(t);
          var n = m(e, !0);
          return j(r), w(Ua, n) ? (r.enumerable ? (w(t, Sa) && t[Sa][n] && (t[Sa][n] = !1), r = Xt(r, {
             enumerable: f(0, !1)
          })) : (w(t, Sa) || Ta(t, Sa, f(1, {})), t[Sa][n] = !0), Da(t, n, r)) : Ta(t, n, r)
       },
       Ka = function (t, e) {
          j(t);
          var r = g(e),
       ...
       Ga = function (t) {
          var e = m(t, !0),
             r = La.call(this, e);
          return !(this === Ra && w(Ua, e) && !w(Ma, e)) && (!(r || !w(this, e) || !w(Ua, e) || w(this, Sa) && this[Sa][e]) || r)
       },
       $a = function (t, e) {
          var r = g(t),
             n = m(e, !0);
          if (r !== Ra || !w(Ua, n) || w(Ma, n)) {
             var o = Ia(r, n);
             return !o || !w(Ua, n) || w(r, Sa) && r[Sa][n] || (o.enumerable = !0), o
          }
       },
       Va = function (t) {
          var e = ka(g(t)),
    ...
    if (Nt || (ja = function () {
          ...
          var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0,
             e = G(t),
             r = function (t) {
                this === Ra && r.call(Ma, t), w(this, Sa) && w(this[Sa], e) && (this[Sa][e] = !1), Da(this, e, f(1, t))
             };
          return i && Ba && Da(Ra, e, {
             configurable: !0,
             set: r
          ...
          return qa(G(t), t)
       })), c.f = Ga, I.f = Wa, R.f = $a, wt.f = ga.f = Va, St.f = Ha, ya.f = function (t) {
          return qa(qt(t), t)
       }, i && (Ta(ja.prototype, "description", {
          configurable: !0,
          get: function () {
       ...
       Lt({
          ...
          stringify: function (t, e, r) {
             ...
             }), o[1] = e, Pa.apply(null, o)
          }
       })
    }
    ja.prototype[xa] || T(ja.prototype, xa, ja.prototype.valueOf), Ce(ja, Ea), H[Sa] = !0, ba("asyncIterator");
    var Ya = I.f,
       Ja = n.Symbol;
    ...
    var _u = qt("iterator"),
       Nu = !o((function () {
          ...
          return t.pathname = "c%20d", e.forEach((function (t, n) {
             e.delete("b"), r += n + t
          })), !e.sort || "http://a/c%20d?a=1&c=3" !== t.href || "3" !== e.get("c") || "a=1" !== String(new URLSearchParams("?a=1")) || !e[_u] || "a" !== new URL("https://a@b").username || "b" !== new URLSearchParams(new URLSearchParams("a=b")).get("a") || "xn--e1aybc" !== new URL("http://тест").host || "#%D0%B1" !== new URL("http://a#б").hash || "a1c3" !== r || "x" !== new URL("http://x", void 0).host
       })),
       Cu = Object.assign,
    ...
    Dr(ys, {
       ...
       URLSearchParams: gs
    }), Nu || "function" != typeof Xu || "function" != typeof Yu || Lt({
       global: !0,
       enumerable: !0,
       forced: !0
    }, {
    ...
    var ms, bs = {
       ...
       Ws = function (t) {
          ...
          for (r = [], n = 0; n < e; n++) {
             if ("" == (o = s[n])) return t;
             if (i = 10, o.length > 1 && "0" == o.charAt(0) && (i = Ms.test(o) ? 16 : 8, o = o.slice(8 == i ? 1 : 2)), "" === o) a = 0;
             else {
       ...
       ec = function (t, e) {
          var r;
          return 2 == t.length && ks.test(t.charAt(0)) && (":" == (r = t.charAt(1)) || !e && "|" == r)
       },
       rc = function (t) {
          var e;
          ...
          for (r || (t.scheme = "", t.username = "", t.password = "", t.host = null, t.port = null, t.path = [], t.query = null, t.fragment = null, t.cannotBeABaseURL = !1, e = e.replace(Ds, "")), e = e.replace(qs, ""), o = dr(e); f <= o.length;) {
             switch (i = o[f], c) {
                case ic:
                   ...
                   break;
                case ac:
                   if (i && (Ls.test(i) || "+" == i || "-" == i || "." == i)) l += i.toLowerCase();
                   else {
                      if (":" != i) {
                         if (r) return Ps;
                         l = "", c = uc, f = 0;
       ...
       jc = function (t) {
          ...
          }, i || (n.href = Ic.call(n), n.origin = Tc.call(n), n.protocol = kc.call(n), n.username = Lc.call(n), n.password = Uc.call(n), n.host = Mc.call(n), n.hostname = _c.call(n), n.port = Nc.call(n), n.pathname = Cc.call(n), n.search = Fc.call(n), n.searchParams = Bc.call(n), n.hash = Dc.call(n))
       },
       Pc = jc.prototype,
       Ic = function () {
          var t = Os(this),
    ...
    if (i && Wt(Pc, {
       ...
       }), rt(Pc, "toJSON", (function () {
          return Ic.call(this)
       }), {
          enumerable: !0
       }), rt(Pc, "toString", (function () {
          return Ic.call(this)
       }), {
          enumerable: !0
       }), Ss) {
    ...
    var Of, Rf, jf, Pf, If = Af || function (t) {
          var e = {
             fn: t,
             next: void 0
          };
       ...
       Yf = Tt(Nf, (function () {
          ...
          return (t.constructor = {})[_f] = e, !(t.then((function () {})) instanceof e)
       })),
       Jf = Yf || !br((function (t) {
    ...
    }, "function" == typeof Vc && (Pf = Vc.prototype.then, rt(Vc.prototype, "then", (function (t, e) {
       var r = this;
    ...
    function El(t) {
       this.map = {}, t instanceof El ? t.forEach((function (t, e) {
          this.append(e, t)
    ...
    function Il(t, e) {
       ...
       if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new El(e.headers)), this.method = (n = (r = e.method || this.method || "GET").toUpperCase(), Pl.indexOf(n) > -1 ? n : r), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && o) throw new TypeError("Body not allowed for GET or HEAD requests");
       this._initBody(o)
    }
    ...
    }, jl.call(Il.prototype), jl.call(kl.prototype), kl.prototype.clone = function () {
    ...
    try {
       ...
       (Ul = function (t, e) {
          ...
          var r = Error(t);
          this.stack = r.stack
       }).prototype = Object.create(Error.prototype), Ul.prototype.constructor = Ul
    }
 
    function Ml(t, e) {
       return new Promise((function (r, n) {
          var o = new Il(t, e);
          if (o.signal && o.signal.aborted) return n(new Ul("Aborted", "AbortError"));
          ...
          i.onload = function () {
             ...
             n.url = "responseURL" in i ? i.responseURL : n.headers.get("X-Request-URL"), r(new kl("response" in i ? i.response : i.responseText, n))
          }, i.onerror = function () {
    ...
    Ml.polyfill = !0, self.fetch || (self.fetch = Ml, self.Headers = El, self.Request = Il, self.Response = kl);
